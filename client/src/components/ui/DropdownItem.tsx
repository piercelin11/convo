	...
	return (
		<li>
			<button
				role="menuitem"
				tabIndex={-1}
				className="flex w-full items-center gap-4 rounded-lg px-4 py-2 text-left text-neutral-400 hover:bg-neutral-950 hover:text-neutral-100 focus:bg-neutral-950"
				{...props}
			>
				{children}
			</button>
